...
<head>
    ...
    <title>Agregar docente | E-School</title>
    ...
    <div class="teacher-form__container">
        ...
        <section class="teacher-form__card">
            <header class="teacher-form__header">
                <h1 class="teacher-form__title">Registrar docente</h1>
                <p class="teacher-form__description">
                    Completa la información del nuevo docente y asigna la materia que imparte.
                </p>
            </header>
            ...
            <form action="{{ route('teachers.store') }}" method="POST" class="teacher-form__form">
                @csrf
                ...
                <div class="teacher-form__group">
                    ...
                    <input
                        ...
                        value="{{ old('subject') }}"
                    >
                    <p class="teacher-form__hint">Escribe la materia principal que impartirá este docente.</p>
                </div>
